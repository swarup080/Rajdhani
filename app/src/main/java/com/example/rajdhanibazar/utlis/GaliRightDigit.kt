...
import com.example.rajdhanibazar.databinding.ActivityGaliRightDigitBinding
...
class GaliRightDigit : AppCompatActivity() {
    private lateinit var binding: ActivityGaliRightDigitBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityGaliRightDigitBinding.inflate(layoutInflater)
            ...
            RetrofitInstance.apiInterface.postBid(addBid).enqueue(object : Callback<BidResponse?> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        val navigate = Intent(this@GaliRightDigit, MainActivity::class.java)
                        navigate.addFlags(
                        ...
                        Toast.makeText(this@GaliRightDigit, bidResponse?.message, Toast.LENGTH_SHORT)
                            .show()
                    } else {
                        // Handle failure in bid creation
                        Toast.makeText(this@GaliRightDigit, "Failed to create bid", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
                ...
                override fun onFailure(call: Call<BidResponse?>, t: Throwable) {
                    ...
                    Toast.makeText(this@GaliRightDigit, t.message, Toast.LENGTH_SHORT).show()
                }
            })
        } else {
            // Show a message if the balance is insufficient
            Toast.makeText(this@GaliRightDigit, "Insufficient balance", Toast.LENGTH_SHORT).show()
        }
    }
            ...
            .enqueue(object : Callback<ResponseBody> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        Toast.makeText(this@GaliRightDigit, responseBody, Toast.LENGTH_SHORT).show()
                    } else {
                        Toast.makeText(
                            this@GaliRightDigit,
