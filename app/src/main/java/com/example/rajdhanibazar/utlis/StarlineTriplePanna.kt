...
import com.example.rajdhanibazar.databinding.ActivityStarlineTriplePannaBinding
import com.example.rajdhanibazar.databinding.ActivityTriplePannaBinding
...
class StarlineTriplePanna : AppCompatActivity() {
    private lateinit var binding: ActivityStarlineTriplePannaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityStarlineTriplePannaBinding.inflate(layoutInflater)
    ...
    private fun getDigit() {
        ...
        if (gameOpenDigit.length != 3) {
            ...
            if (digit1 == digit2 && digit1 == digit3) {
                ...
                Toast.makeText(
                    this,
                    "Valid input: All three digits are the same",
                    Toast.LENGTH_SHORT
                ).show()
            } else {
                Toast.makeText(this, "All three digits must be the same", Toast.LENGTH_SHORT).show()
            }
        }
    }
            ...
            RetrofitInstance.apiInterface.postBid(addBid).enqueue(object : Callback<BidResponse?> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        val navigate = Intent(this@StarlineTriplePanna, MainActivity::class.java)
                        navigate.addFlags(
                        ...
                        Toast.makeText(this@StarlineTriplePanna, bidResponse?.message, Toast.LENGTH_SHORT)
                            .show()
                    } else {
                        // Handle failure in bid creation
                        Toast.makeText(this@StarlineTriplePanna, "Failed to create bid", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
                ...
                override fun onFailure(call: Call<BidResponse?>, t: Throwable) {
                    ...
                    Toast.makeText(this@StarlineTriplePanna, t.message, Toast.LENGTH_SHORT).show()
                }
            })
        } else {
            // Show a message if the balance is insufficient
            Toast.makeText(this@StarlineTriplePanna, "Insufficient balance", Toast.LENGTH_SHORT).show()
        }
    }
            ...
            .enqueue(object : Callback<ResponseBody> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        Toast.makeText(this@StarlineTriplePanna, responseBody, Toast.LENGTH_SHORT).show()
                    } else {
                        Toast.makeText(
                            this@StarlineTriplePanna,
