...
class SingleDigit : AppCompatActivity() {
    private lateinit var binding: ActivitySingleDigitBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySingleDigitBinding.inflate(layoutInflater)
            ...
            RetrofitInstance.apiInterface.postBid(addBid).enqueue(object : Callback<BidResponse?> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        val navigate = Intent(this@SingleDigit, MainActivity::class.java)
                        navigate.addFlags(
                        ...
                        Toast.makeText(this@SingleDigit, bidResponse?.message, Toast.LENGTH_SHORT)
                            .show()
                    } else {
                        // Handle failure in bid creation
                        Toast.makeText(this@SingleDigit, "Failed to create bid", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
                ...
                override fun onFailure(call: Call<BidResponse?>, t: Throwable) {
                    ...
                    Toast.makeText(this@SingleDigit, t.message, Toast.LENGTH_SHORT).show()
                }
            })
        } else {
            // Show a message if the balance is insufficient
            Toast.makeText(this@SingleDigit, "Insufficient balance", Toast.LENGTH_SHORT).show()
        }
    }
            ...
            .enqueue(object : Callback<ResponseBody> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        Toast.makeText(this@SingleDigit, responseBody, Toast.LENGTH_SHORT).show()
                    } else {
                        Toast.makeText(
                            this@SingleDigit,
