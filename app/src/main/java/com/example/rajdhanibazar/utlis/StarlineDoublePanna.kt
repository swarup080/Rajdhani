...
import com.example.rajdhanibazar.databinding.ActivityStarlineDoublePannaBinding
...
class StarlineDoublePanna : AppCompatActivity() {
    private lateinit var binding: ActivityStarlineDoublePannaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityStarlineDoublePannaBinding.inflate(layoutInflater)
            ...
            RetrofitInstance.apiInterface.postBid(addBid).enqueue(object : Callback<BidResponse?> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        val navigate = Intent(this@StarlineDoublePanna, MainActivity::class.java)
                        navigate.addFlags(
                        ...
                        Toast.makeText(this@StarlineDoublePanna, bidResponse?.message, Toast.LENGTH_SHORT)
                            .show()
                    } else {
                        // Handle failure in bid creation
                        Toast.makeText(this@StarlineDoublePanna, "Failed to create bid", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
                ...
                override fun onFailure(call: Call<BidResponse?>, t: Throwable) {
                    ...
                    Toast.makeText(this@StarlineDoublePanna, t.message, Toast.LENGTH_SHORT).show()
                }
            })
        } else {
            // Show a message if the balance is insufficient
            Toast.makeText(this@StarlineDoublePanna, "Insufficient balance", Toast.LENGTH_SHORT).show()
        }
    }
            ...
            .enqueue(object : Callback<ResponseBody> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        Toast.makeText(this@StarlineDoublePanna, responseBody, Toast.LENGTH_SHORT).show()
                    } else {
                        Toast.makeText(
                            this@StarlineDoublePanna,
